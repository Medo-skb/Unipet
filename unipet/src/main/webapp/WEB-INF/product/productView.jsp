			...
			<div v-if="product" class="detail-box">
				<div class="detail-wrap">
					...
					<div class="detail-right">
						...
						<div class="price">{{formatPrice(product && product.productPrice)}}원</div>
							...
							<div v-if="qna.open" class="qna-body-box">
								<div v-if="qna.editMode" class="qna-edit-box">
									...
									<div class="qna-edit-btn-row">
										...
										<button class="qna-small-btn cancel" @click="fnCancelEditQna(qna)">취소</button>
									</div>
								</div>
								...
								<div v-else>
									...
									<div class="qna-btn-row" v-if="fnCanManageQna(qna)">
										...
										<button class="qna-small-btn delete" @click="fnDeleteQna(qna.qnaNo)">삭제</button>
									</div>
								</div>
							</div>
						</div>
