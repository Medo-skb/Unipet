	...
	<body>
		...
		<div id="app">
			...
			<div class="recommend-box">
				<div v-for="item in recommendList" class="product-card">
					<img :src="item.FILE_PATH + item.FILE_NAME" width="150">
						...
						<div v-else class="product-list">
							<div class="product-card" v-for="item in productList" :key="item.PRODUCT_NO"
								...
								<div class="product-image-box">
									...
									<img v-else src="http://localhost:8080/img/no-image.png" class="product-image">
								</div>
