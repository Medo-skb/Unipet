                        ...
                        <div v-if="currentMenu === 'userMyPage'">
                            ...
                            : '/img/no-image.png'" alt="상품이미지">
                                                    ...
                                                    <div class="main-order-info">
                                                        <div class="list-title">
                                                            {{ (group.orderDate || '').substring(0, 10) }}
                                                        </div>

                                                        <div class="list-sub">
                                                            {{ (group.orderDate || '').substring(11, 16) }}
                                                        </div>
                    ...
                    <div v-if="currentMenu === 'subscriptionPage'">
                        <div class="section-box">
                            ...
                            <div v-else class="empty-text-box">
                                ...
                                <button class="small-btn" @click="fnGoToSubPage" style="margin-top: 5pt;">프리미엄
                                    구독하기</button>
                            </div>
                        </div>
                    ...
                    <div v-if="currentMenu === 'orderList'">
                        <div class="section-box">
                            ...
                            <div class="info-card" v-for="group in pagedOrderList" :key="group.orderNo"
                                ...
                                <div v-for="order in group.items"
                                    ...
                                    <div style="flex:1;">
                                        ...
                                        <div class="list-status" v-if="(order.payStatus || order.PAY_STATUS) !== 'CAN'">
                                            배송상태 :
                            ...
                            <div class="btn-box paging-box" v-if="orderTotalPage > 1">
                                ...
                                <button class="small-btn" :disabled="orderPage === 1" @click="orderPage--">
                                    이전
                                </button>
                                ...
                                <button class="small-btn" :disabled="orderPage === orderTotalPage" @click="orderPage++">
                                    다음
                                </button>
            ...
            const app = Vue.createApp({
                ...
                methods: {
                    ...
                    fnGetPayStatusText: function (status) {
                        ...
                        status = String(status).trim().toUpperCase();
                        switch (status) {
                            case "RDY": return "결제대기";
                            case "PAY": return "결제완료";
                            case "CAN": return "결제취소";
                            case "FAL": return "결제실패";
