                                ...
                                <div class="mini-panel-body">
                                    ...
                                    <div class="main-reserve-item" v-for="item in reservationList.slice(0, 2)"
                                        ...
                                        <div>
                                            ...
                                            <div class="list-sub">{{ item.rsvDate || '-' }} {{ item.rsvStartTime
                                                || '-' }}</div>
                                        </div>
                            ...
                            <div class="mini-panel">
                                ...
                                <div class="mini-panel-body">
                                    ...
                                    <div class="main-order-item" v-for="group in groupedOrderList.slice(0, 2)"
                                        ...
                                        <div class="status-badge"
                                            :class="getOrderStatusClass(group.items[0]?.orderStatus)">
                ...
                <div class="section-box">
                    ...
                    <div class="info-card" v-for="group in groupedOrderList" :key="group.orderNo"
                        ...
                        <div v-for="order in group.items"
                            ...
                            <div style="flex:1;">
                                <div class="list-title">{{ order.productName || ('주문번호 ' + (order.orderNo ||
                                    '-')) }}</div>
            ...
            <div v-if="currentMenu === 'reserveList'">
                <div class="section-box">
                    ...
                    <div class="list-item" v-for="item in reservationAllList" :key="'all-' + item.rsvNo">
                        ...
                        <div class="list-sub">시간 : {{ item.rsvStartTime || '-' }} ~ {{ item.rsvEndTime || '-' }}
                        </div>
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        if (res.result === true || res.result === "success") {
                            if (res.info) {
                                self.point = res.info.point || res.info.POINT || 0;
                            } else {
                                self.point = res.point || 0;
                            }
                        } else {
                            self.point = 0;
                        }
