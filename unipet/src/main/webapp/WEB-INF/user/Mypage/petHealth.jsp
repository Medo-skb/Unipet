                            ...
                            <div class="info-card" v-for="item in healthList" :key="item.id || item.healthNo">
                                ...
                                <div class="btn-box">
                                    ...
                                    <button class="btn-red"
                                        @click="fnDeleteHealth(item.id || item.healthNo)">삭제</button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="section-box">
                            ...
                            <div class="info-card" v-for="item in weightList" :key="item.id || item.weightNo">
                                ...
                                <div class="btn-box">
                                    ...
                                    <button class="btn-red"
                                        @click="fnDeleteWeight(item.id || item.weightNo)">삭제</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div v-if="healthTab === 'vaccine'">
                        ...
                        <div class="section-box">
                            ...
                            <div class="info-card" v-for="item in vacList" :key="item.id || item.vacNo">
                                ...
                                <div class="list-sub">
                                    다음 접종일 : {{ item.nextDate || item.nextVacDate ? fnFormatDate(item.nextDate ||
                                    item.nextVacDate) : '-' }}
                                </div>
