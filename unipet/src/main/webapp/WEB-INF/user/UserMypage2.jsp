    ...
    <body>
                    ...
                    <div class="page-inner">
                        ...
                        <div v-if="currentMenu === 'subscriptionPage'">
                            <div class="section-box">
                                ...
                                <div class="btn-box">
                                    <button class="small-btn" v-if="subscriptionInfo.status !== '만료'"
                                        @click="updateAutoPay">
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/css/main/footer.css"> -->
                                        ...
                                        <div class="user-page-container">
                                            ...
                                            <aside class="user-sidebar">
                                                ...
                                                <ul class="sidebar-menu">
                                                    <li class="menu-item" :class="{active: currentMenu==='userMyPage'}">
                                                        <button type="button"
                                                            @click="changeMenu('userMyPage')">홈</button>
                                                    </li>

                                                    <li class="menu-item"
                                                        :class="{active: currentMenu==='subscriptionPage'}">
                                                        <button type="button"
                                                            @click="changeMenu('subscriptionPage')">구독</button>
                                                    </li>

                                                    <li class="menu-item"
                                                        :class="{active: currentMenu==='communityPage'}">
                                                        <button type="button"
                                                            @click="changeMenu('communityPage')">커뮤니티</button>
                                                    </li>

                                                    <li class="menu-item" :class="{active: currentMenu==='orderList'}">
                                                        <button type="button"
                                                            @click="changeMenu('orderList')">주문내역</button>
                                                    </li>

                                                    <li class="menu-item"
                                                        :class="{active: currentMenu==='reserveList'}">
                                                        <button type="button"
                                                            @click="changeMenu('reserveList')">예약내역</button>
                                                    </li>

                                                    <li class="menu-item" :class="{active: currentMenu==='petEdit'}">
                                                        <button type="button"
                                                            @click="changeMenu('petEdit')">반려동물</button>
                                                    </li>

                                                    <li class="menu-item" :class="{active: currentMenu==='petMyPage'}">
                                                        <button type="button"
                                                            @click="changeMenu('petMyPage')">건강조회</button>
                                                    </li>

                                                    <li class="menu-item"
                                                        :class="{active: currentMenu==='petHealthPage'}">
                                                        <button type="button"
                                                            @click="changeMenu('petHealthPage')">건강기록</button>
                                                    </li>

                                                    <li class="menu-item" :class="{active: currentMenu==='petVacPage'}">
                                                        <button type="button"
                                                            @click="changeMenu('petVacPage')">접종기록</button>
                                                    </li>

                                                    <li class="menu-item"
                                                        :class="{active: currentMenu==='petWeightPage'}">
                                                        <button type="button"
                                                            @click="changeMenu('petWeightPage')">몸무게</button>
                                                    </li>

                                                    <li class="menu-item" :class="{active: currentMenu==='pointInfo'}">
                                                        <button type="button"
                                                            @click="changeMenu('pointInfo')">포인트</button>
                                                    </li>

                                                    <li class="menu-item" :class="{active: currentMenu==='couponInfo'}">
                                                        <button type="button"
                                                            @click="changeMenu('couponInfo')">쿠폰</button>
                                                    </li>
                                                </ul>
                                            </aside>
                                                        ...
                                                        <div class="mypage-dashboard">
                                                            ...
                                                            <div class="dash-left">
                                                                ...
                                                                <div class="section-box">
                                                                    ...
                                                                    <div class="profile-summary">
                                                                        <div class="profile-info-box">
                                                                            ...
                                                                            <div class="profile-info-row">
                                                                                <div class="profile-info-label">닉네임
                                                                                </div>
                                                                                <div>{{ user.nickname || '-' }}</div>
                                                                            </div>
                                                                            <div class="profile-info-row">
                                                                                <div class="profile-info-label">이메일
                                                                                </div>
                                                                                <div>{{ user.email || '-' }}</div>
                                                                            </div>
                                                                            <div class="profile-info-row">
                                                                                <div class="profile-info-label">전화번호
                                                                                </div>
                                                                                <div>{{ user.phone || '-' }}</div>
                                                                            </div>
                                                                            <div class="profile-info-row">
                                                                            ...
                                                                            <div class="btn-box"
                                                                                ...
                                                                                <button
                                                                                    @click="openUserEditPanel = !openUserEditPanel">
                                                                                    {{ openUserEditPanel ? '수정 닫기' :
                                                                                    '회원정보 수정' }}
                                                                                </button>
                                                                                <button class="btn-gray"
                                                                                    @click="openPwdModal">비밀번호
                                                                                    변경</button>
                                                                                <button class="btn-red"
                                                                                    @click="deleteUser">회원 탈퇴</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>

                                                                    <div v-if="openUserEditPanel"
                                                                        style="margin-top:16px;">
                                                                        <div class="grid-2">
                                                                            <div class="row"><label>이름</label><input
                                                                                    type="text" v-model="user.userName">
                                                                            </div>
                                                                            <div class="row"><label>닉네임</label><input
                                                                                    type="text" v-model="user.nickname">
                                                                            </div>
                                                                            <div class="row"><label>이메일</label><input
                                                                                    type="text" v-model="user.email">
                                                                            </div>
                                                                            <div class="row"><label>전화번호</label><input
                                                                                    type="text" v-model="user.phone">
                                                                            </div>
                                                                            <div class="row"><label>우편번호</label><input
                                                                                    type="text" v-model="user.zipcode">
                                                                            </div>
                                                                            <div class="row"><label>주소</label><input
                                                                                    type="text" v-model="user.userAddr">
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <div class="section-box">
                                                                    ...
                                                                    <div class="pet-list">
                                                                        <div class="pet-card" v-for="pet in petList"
                                                                            :key="pet.petNo">
                                                                            <div class="pet-thumb">
                                                                                <div class="pet-avatar">
                                                                            ...
                                                                            <div class="pet-body">
                                                                                ...
                                                                                <button
                                                                                    :disabled="String(pet.isMain || pet.IS_MAIN).trim().toUpperCase() === 'Y'"
                                                                                    class="pet-btn main"
                                                                                    @click="changeMainPet(pet.petNo)">
                                                                                    {{ String(pet.isMain ||
                                                                                    pet.IS_MAIN).trim().toUpperCase()
                                                                                    ===
                                                                                    'Y' ? ' 대표' : '대표로 변경' }}
                                                                                </button>
                                                                            </div>
                                                            ...
                                                            <div class="dash-right">
                                                                ...
                                                                <div class="section-box">
                                                                    ...
                                                                    <div class="info-card">
                                                                        <div class="list-title">내 게시글</div>
                                                                        <div class="list-sub">총 {{ myPostList.length }}건
                                                                        </div>

                                                                        <div v-if="myPostList.length === 0"
                                                                            class="empty-text">
                                                                            작성한 게시글이 없습니다.
                                                                        </div>

                                                                        <div v-for="item in recentPostList.slice(0, 2)"
                                                                            :key="'post-' + item.id" class="list-item">
                                                                            <div class="list-title">
                                                                                [{{ item.boardName }}] {{ item.title }}
                                                                            </div>
                                                                            <div class="list-sub">
                                                                    ...
                                                                    <div class="info-card">
                                                                        <div class="list-title">내 댓글</div>
                                                                        <div class="list-sub">총 {{ myCommentList.length
                                                                            }}건</div>

                                                                        <div v-if="myCommentList.length === 0"
                                                                            class="empty-text">
                                                                            작성한 댓글이 없습니다.
                                                                        </div>

                                                                        <div v-for="item in myCommentList.slice(0, 2)"
                                                                            :key="'comment-' + item.id"
                                                                            class="list-item">
                                                                            <div class="list-title">
                                                                                [{{ item.boardName }}] {{ item.content
                                                            ...
                                                            <div class="mini-dashboard">
                                                                <div class="mini-panel">
                                                                    ...
                                                                    <div class="mini-panel-body">
                                                                        ...
                                                                        <div class="main-reserve-item"
                                                                            v-for="item in reservationList.slice(0, 2)"
                                                                            :key="item.rsvNo">
                                                                            <div>
                                                                                <div class="list-title">{{ item.rsvDate
                                                                                    || '-' }}</div>
                                                                                <div class="list-sub">
                                                                                    {{ item.rsvStartTime || '-' }} ~ {{
                                                                                    item.rsvEndTime || '-' }}
                                                                        ...
                                                                        <div class="btn-box">
                                                                            <button
                                                                                @click="changeMenu('reserveList')">예약 내역
                                                                                보기</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="mini-panel">
                                                                <div class="mini-panel-head">최근 주문 내역</div>
                                                                <div class="mini-panel-body">
                                                                    <div v-if="groupedOrderList.length === 0"
                                                                        class="empty-text">
                                                                        주문 내역이 없습니다.
                                                                    </div>

                                                                    <div class="main-order-item"
                                                                        v-for="group in groupedOrderList.slice(0, 2)"
                                                                        :key="group.orderNo">
                                                                        <div
                                ...
                                : '/img/no-image.png'" alt="상품이미지">
                                                                    ...
                                                                    <div class="btn-box">
                                                                        <button @click="changeMenu('orderList')">주문 내역
                                                                            보기</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div v-if="currentMenu === 'subscriptionPage'">
                                                        <div class="section-box">
                                                            ...
                                                            <div class="info-card">
                                                                <div class="list-title">{{ subscriptionInfo.planName ||
                                                                    '구독 정보 없음' }}</div>
                                                                <div class="list-sub">상태 : {{
                                                                    getSubStatusText(subscriptionInfo.status)}}</div>
                                                                <div class="list-sub">다음 결제일 : {{
                                                                    subscriptionInfo.nextBillingDate || '-' }}</div>
                                                                <div class="list-sub">
                                                                    자동결제 : {{ subscriptionInfo.isAuto === 'Y' ? '사용중' :
                                                                    '미사용' }}
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="btn-box">
                                                                <button class="small-btn"
                                                                    v-if="subscriptionInfo.status !== '만료'"
                                                                    @click="updateAutoPay">
                                                                    자동결제 {{ subscriptionInfo.isAuto === 'Y' ? '해지' :
                                                                    '설정' }}
                                                                </button>
                                                                ...
                                                                <button class="small-btn"
                                                                    @click="toggleSubscriptionPayList">
                                                                    {{ showSubscriptionPayList ? '결제내역 닫기' : '결제내역 보기'
                                                                    }}
                                                                </button>
                                                            </div>
                                                            ...
                                                            <div class="list-sub"
                                                                v-if="subscriptionInfo.canChangeAuto !== 'Y'">
                                                                자동결제 변경은 다음 결제일 1일 전까지만 가능합니다.
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="section-box" v-if="showSubscriptionPayList">
                                                            ...
                                                            <div v-if="subscriptionPayList.length === 0"
                                                                class="empty-text">
                                                                구독 결제내역이 없습니다.
                                                            </div>

                                                            <div class="info-card" v-for="item in subscriptionPayList"
                                                                :key="item.subNo">
                                                                <div class="list-title">
                                                                    {{ Number(item.subPrice || 0).toLocaleString() }}원
                                                                </div>
                                                                <div class="list-sub">구독 시작일 : {{ item.startDate || '-'
                                                                    }}</div>
                                                                <div class="list-sub">구독 종료일 : {{ item.endDate || '-' }}
                                                                </div>
                                                                <div class="list-sub">다음 결제일 : {{ item.nextBillingDate
                                                                    || '-' }}</div>
                                                                <div class="list-sub">상태 : {{ item.statusText || '-' }}
                                                                </div>
                                                                <div class="list-sub">자동결제 : {{ item.autoText || '-' }}
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div v-if="currentMenu === 'communityPage'">
                                                        <div class="section-box">
                                                            <div class="section-header">
                                                                <div class="section-title" style="margin-bottom:0;">최근 내
                                                                    게시글</div>
                                                                <button class="small-btn"
                                                                    @click="goCommunityPostList">전체 게시글 보기</button>
                                                            </div>

                                                            <div v-if="recentPostList.length === 0" class="empty-text">
                                                                작성한 게시글이 없습니다.</div>

                                                            <div class="list-item" v-for="item in recentPostList"
                                                                :key="'post-page-' + item.id">
                                                                <div class="list-title">
                                                                    [{{ item.boardName }}] {{ item.title }}
                                                                </div>
                                                                <div class="list-sub">{{ formatDateTime(item.cdate) }}
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="section-box">
                                                            ...
                                                            <div class="list-item" v-for="item in myCommentList"
                                                                :key="'comment-page-' + item.id">
                                                                <div class="list-title">
                                                                    [{{ item.boardName || '커뮤니티' }}] {{ item.content }}
                                                                </div>
                                                                <div class="list-sub">{{ formatDateTime(item.cdate) }}
                                                    ...
                                                    <div v-if="currentMenu === 'communityPostList'">
                                                        <div class="section-box">
                                                            <div class="section-header">
                                                                <div class="section-title" style="margin-bottom:0;">내 전체
                                                                    게시글</div>
                                                                <button class="small-btn"
                                                                    @click="changeMenu('communityPage')">커뮤니티로</button>
                                                            </div>

                                                            <div v-if="myPostList.length === 0" class="empty-text">작성한
                                                                게시글이 없습니다.</div>

                                                            <div class="list-item" v-for="item in myPostList"
                                                                :key="'post-all-' + item.id">
                                                                <div class="list-title">
                                                                    [{{ item.boardName }}] {{ item.title }}
                                                                </div>
                                                                <div class="list-sub">{{ formatDateTime(item.cdate) }}
                                                    ...
                                                    <div v-if="currentMenu === 'orderList'">
                                                        <div class="section-box">
                                                            ...
                                                            <div class="info-card" v-for="group in pagedOrderList"
                                                                :key="group.orderNo" style="margin-bottom:16px;">
                                                                ...
                                                                <div v-for="order in group.items"
                                                                    ...
                                                                    <div style="flex:1;">
                                                                        <div class="list-title">{{ order.productName ||
                                                                            '-' }}</div>
                                                                        <div class="list-sub">수량 : {{ order.qty }}개
                                                                        </div>
                                                                        <div class="list-sub">금액 : {{ Number(order.price
                                                                            || 0).toLocaleString()
                                                                            }}원
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div v-if="currentMenu === 'orderDetail'">
                                                        <div class="section-box">
                                                            <div class="section-header">
                                                                <div class="section-title" style="margin-bottom:0;">주문
                                                                    상세</div>
                                                                <button class="small-btn"
                                                                    @click="goOrderList()">주문목록으로</button>
                                                            </div>

                                                            <div class="info-card" style="margin-bottom:18px;">
                                                                <div class="list-sub">주문일자 : {{
                                                                    selectedOrderGroup.orderDate }}</div>
                                                                <div class="list-sub">총 상품 수 : {{
                                                                    selectedOrderGroup.items.length }}건</div>
                                                            </div>

                                                            <div v-if="selectedOrderGroup.items.length === 0"
                                                                class="empty-text">
                                                                주문 상세 내역이 없습니다.
                                                            </div>

                                                            <div class="info-card"
                                                                v-for="order in selectedOrderGroup.items"
                                                                :key="'detail-' + (order.orderDetailNo || order.orderNo + '-' + order.productNo)">
                                                                ...
                                                                <div class="order-item">
                                                                    ...
                                                                    <div style="flex:1;">
                                                                        ...
                                                                        <div class="list-status">
                                                                            결제상태 : {{ getPayStatusText(order.payStatus
                                                                            || order.PAY_STATUS) }}
                                                                        </div>

                                                                        <div class="list-status">
                                                                            배송상태 : {{ getDeliStatusText(order.deliStatus
                                                                            || order.DELI_STATUS)
                                                                            }}
                                                                        </div>
                                                                        ...
                                                                        <div class="btn-box">
                                                                            ...
                                                                            <button class="small-btn"
                                                                                v-if="canViewWrittenReview(order)"
                                                                                @click="openWrittenReview(order)">
                                                                                작성완료 리뷰 보기
                                                                            </button>
                                                    ...
                                                    <div v-if="currentMenu === 'reviewdetailView'">
                                                        <div class="section-box">
                                                            ...
                                                            <div class="section-header">
                                                                <div class="section-title">리뷰 상세</div>
                                                                <button class="small-btn"
                                                                    @click="changeMenu('orderList')">주문목록으로</button>
                                                            </div>
                                                            ...
                                                            <div class="info-card">
                                                                ...
                                                                <div class="list-sub">
                                                                    ...
                                                                    selectedReview.REVIEW_CONTENT || '리뷰 없음' }}
                                                                </div>
                                                    ...
                                                    <div v-if="currentMenu === 'reserveList'">
                                                        <div class="section-box">
                                                            <div class="section-header">
                                                                <div class="section-title" style="margin-bottom:0;">예약
                                                                    내역</div>
                                                            </div>
                                                            ...
                                                            <div v-if="reservationAllList.length === 0"
                                                                class="empty-text">
                                                                예약 내역이 없습니다.
                                                            </div>
                                                            ...
                                                            <div v-for="group in pagedReservationList" :key="group.date"
                                                                ...
                                                                <div class="info-card" v-for="item in group.items"
                                                                    :key="'all-' + item.rsvNo">
                                                                    <div
                                                                        style="display:flex; justify-content:space-between; align-items:center; gap:12px;">
                                                                        <div style="flex:1;">
                                                        ...
                                                        rsvNo: item.rsvNo || item.RSV_NO
                                                            ...
                                                            <div class="btn-box paging-box" v-if="rsvTotalPage > 1">
                                                                <button class="small-btn" :disabled="rsvPage === 1"
                                                                    @click="rsvPage--">이전</button>
                                                                <span>{{ rsvPage }} / {{ rsvTotalPage }}</span>
                                                                <button class="small-btn"
                                                    ...
                                                    <div v-if="currentMenu === 'petEdit'">
                                                        <div class="section-box">
                                                            <div class="section-header">
                                                                <div class="section-title" style="margin-bottom:0;">반려동물
                                                                    프로필 관리</div>
                                                                <button class="small-btn" @click="openAddPetModal">프로필
                                                                    추가</button>
                                                            </div>
                                                            ...
                                                            <div class="pet-list">
                                                                <div class="pet-card" v-for="pet in petList"
                                                                    ...
                                                                    <div class="pet-body">
                                                                        <div class="pet-name">{{ pet.petName }}</div>
                                                                        <div class="pet-info">{{ pet.species || '' }}{{
                                                                            pet.birthdate ? ' · ' +
                                                                            getPetAge(pet.birthdate) + '살' : '' }}</div>
                                                                        <div class="pet-btns">
                                                                            <div class="pet-sub-btn-row">
                                                    ...
                                                    <div v-if="currentMenu === 'petMyPage'">
                                                        ...
                                                        <div class="section-box">
                                                            <div class="section-title">건강 기록 조회</div>
                                                            <div v-if="healthList.length === 0" class="empty-text">건강
                                                                기록이 없습니다.</div>

                                                            <div class="info-card" v-for="item in healthList"
                                                                :key="'h-' + item.id">
                                                                <div class="list-title">{{ item.title }}</div>
                                                                <div class="list-sub">기록일 : {{ formatDate(item.date) }}
                                                                </div>
                                                                <div class="list-sub">내용 : {{ item.memo }}</div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div v-if="currentMenu === 'petHealthPage'">
                                                            ...
                                                            <div class="section-box">
                                                                ...
                                                                <div class="info-card" v-for="item in healthList"
                                                                    ...
                                                                    <div class="list-sub">반려동물 : {{ item.petName || '-'
                                                                        }}</div>
                                                                    <div class="list-sub">기록일 : {{ formatDate(item.date)
                                                                        }}</div>
                                                                    <div class="list-sub">내용 : {{ item.memo || '-' }}
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="section-box">
                                                            ...
                                                            <div v-if="vacList.length === 0" class="empty-text">접종 기록이
                                                                없습니다.</div>

                                                            <div class="info-card" v-for="item in vacList"
                                                                :key="'v-' + item.id">
                                                                <div class="list-title">{{ item.name }}</div>
                                                                <div class="list-sub">반려동물 : {{ item.petName }}</div>
                                                                <div class="list-sub">접종일 : {{ formatDate(item.date) }}
                                                                </div>
                                                                <div class="list-sub">다음 접종일 : {{ item.nextDate ?
                                                        ...
                                                        <div class="section-box">
                                                            ...
                                                            <div v-if="weightList.length === 0" class="empty-text">몸무게
                                                                기록이 없습니다.</div>

                                                            <div class="info-card" v-for="item in weightList"
                                                                :key="'w-' + item.id">
                                                    ...
                                                    <div v-if="currentMenu === 'petVacPage'">
                                                        ...
                                                        <div class="section-box">
                                                            ...
                                                            <div class="info-card" v-for="item in vacList"
                                                                ...
                                                                <div class="list-sub">병원명 : {{ item.hospitalName || '-'
                                                                    }}</div>
                                                                <div class="list-sub">비고 : {{ item.memo || '-' }}</div>

                                                                <div class="btn-box">
                                                                    <button class="btn-red"
                                                                        @click="deleteVaccine(item.id)">삭제</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="section-box">
                                                            ...
                                                            <div class="info-card" v-for="item in sortedPointUseList"
                                                                ...
                                                                <div class="list-title"
                                                                    ...
                                                                    {{ Number(item.pointAmount ?? item.POINT_AMOUNT ??
                                                                    0) > 0 ? '+' : '' }}
                                                                    {{ Number(item.pointAmount ?? item.POINT_AMOUNT ??
                                                                    0).toLocaleString() }} P
                                                                </div>
                                                                ...
                                                                <div class="list-sub">
                                                                    잔액 : {{ Number(item.balance ?? item.BALANCE ??
                                                                    0).toLocaleString() }} P
                                                                </div>

                                                                <div class="list-sub">주문번호 : {{ item.ordNo ||
                                                                    item.ORD_NO || '-' }}</div>
                                                                <div class="list-sub">날짜 : {{ item.cdate || item.CDATE
                                                                    || '-' }}</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="modal-wrap" v-if="showPetModal">
                                                        <div class="modal-box">
                                                            ...
                                                            <div class="row"><label>이름</label><input type="text"
                                                                    v-model="petForm.petName"></div>
                                                            <div class="row"><label>종</label><input type="text"
                                                                    v-model="petForm.species"></div>
                                                            <div class="row"><label>품종</label><input type="text"
                                                                    v-model="petForm.breed"></div>
                                                            <div class="row"><label>생년월일</label><input type="date"
                                                    ...
                                                    <div class="modal-wrap" v-if="showPwdModal">
                                                        <div class="modal-box">
                                                            ...
                                                            <div class="row"><label>현재 비밀번호</label><input
                                                                    type="password" v-model="pwdForm.pwd">
                                                            </div>
                                                            <div class="row"><label>새 비밀번호</label><input type="password"
                                                                    v-model="pwdForm.newPwd">
                                                            </div>

                                                            <div class="modal-btns">
                                                                <button class="btn-cancel"
                                                                    @click="closePwdModal">취소</button>
                                                                <button class="btn-save"
                                                                    @click="changePassword">변경</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        methods: {
                                                            ...
                                                            loadPointUseList() {
                                                                $.ajax({
                                                                    ...
                                                                    dataType: "json",
                                                                    success: (data) => {
                                                                        console.log("포인트 사용내역 응답 =", data);

                                                                        if (data.result === "success") {
                                                                            this.pointUseList = data.pointUseList || [];
                                                                        } else {
                                                                            this.pointUseList = [];
                                                                        }
                                                                    },
                                                                    error: (xhr) => {
                                                                        console.log("포인트 사용내역 에러 =", xhr.responseText);
                                                                        this.pointUseList = [];
                                                                    }
                                                                });
                                                            },
                        ...
                        <div v-if="currentMenu === 'couponInfo'">
                            <div class="section-box">
                                ...
                                <div class="info-card" v-for="coupon in filteredCouponList"
                                    ...
                                    <div class="list-sub">
                                        할인금액 :
                                        {{ Number(coupon.discountAmt || coupon.DISCOUNT_AMT || 0).toLocaleString() }}원
                                    </div>
                        ...
                        <div class="modal-wrap" v-if="showPetModal">
                            <div class="modal-box">
                                ...
                                <div class="row"><label>생년월일</label><input type="date" v-model="petForm.birthdate">
                                </div>
                        ...
                        <div class="modal-wrap" v-if="showPwdModal">
                            <div class="modal-box">
                                ...
                                <div class="row"><label>현재 비밀번호</label><input type="password" v-model="pwdForm.pwd">
                                </div>
                                <div class="row"><label>새 비밀번호</label><input type="password" v-model="pwdForm.newPwd">
                                </div>
